package Helpers;
// Data de los import del juego de preguntas
import Class.Juego;
...
public class Data {
    public static LinkedList<Juego> getJuego(){
     ...
     LinkedList<Juego> ListaJuegos = new LinkedList<Juego>();
       try{
                CollectionReference cnombres=Conection.getInstance().collection("Juegos");
    ...
    LinkedList<Ronda> ListaRondas = new LinkedList<Ronda>();
       try{
                ...
                CollectionReference cnombres=Conection.getInstance().collection("Categorias");
                ApiFuture<QuerySnapshot> query=cnombres.get();
